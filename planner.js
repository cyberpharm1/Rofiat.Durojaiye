...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var tasks = [
    ...
    { id: 2, title: 'Review SOC monitoring case study', course: 'Cybersecurity', due: '2026-07-18', done: true },
    { id: 3, title: 'Submit web technologies portfolio link', course: 'COS 106', due: '2026-07-22', done: false }
  ];
